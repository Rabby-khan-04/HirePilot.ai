  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <section className="flex-1 flex flex-col justify-center items-center bg-surface p-6 md:p-margin-page relative">
        {/* Background grid */}
        <div className="absolute inset-0 opacity-40 pointer-events-none bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] bg-size-[40px_40px]" />
