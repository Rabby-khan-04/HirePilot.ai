...
function FeatureItem({ icon: Icon, title, description }) {
  return (
    <div className="flex items-start gap-4 group">
      <div className="shrink-0 w-10 h-10 border border-on-primary/20 flex items-center justify-center bg-on-primary/5 group-hover:bg-on-primary/20 transition-colors">
        <Icon size={20} className="text-on-primary" />
      </div>
      <div>
        <span className="font-mono-label text-mono-label text-on-primary block mb-1">
          {title}
        </span>
        <span className="text-on-primary/50 text-xs">{description}</span>
      </div>
    </div>
  );
}
...
export default function RegisterMarketing() {
  return (
    <aside className="relative hidden md:flex md:w-1/2 lg:w-3/5 bg-tertiary-container text-on-primary p-margin-page flex-col justify-between overflow-hidden border-r border-outline-variant/20">
      ...
      <div className="relative z-10 max-w-xl">
        <div className="inline-block bg-on-primary/5 border border-on-primary/10 px-4 py-1 mb-gutter">
        ...
        <p className="font-body-md text-body-md text-on-primary/70 mb-12 leading-relaxed">
      ...
      {/* Left side footer */}
      <div className="relative z-10 pt-12 border-t border-on-primary/5 mt-12">
        <span className="font-mono-detail text-mono-detail text-on-primary/40">
