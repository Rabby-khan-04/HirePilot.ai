...
export default function CreateRoadmapCard() {
  return (
    <Link
      ...
      className="bg-transparent border border-dashed border-outline-variant/60 rounded-lg p-6 flex flex-col items-center justify-center group cursor-pointer hover:border-on-background transition-colors min-h-80 md:min-h-95"
    >
